...
})({"f5LC8":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "5bcd841120914779";
"use strict";
...
},{}],"ids6w":[function(require,module,exports,__globalThis) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
var _three = require("three");
var _orbitControlsJs = require("three/examples/jsm/controls/OrbitControls.js");
var _osbJpg = require("../img/OSB.jpg");
var _osbJpgDefault = parcelHelpers.interopDefault(_osbJpg);
var _keperJpg = require("../img/KEPER.jpg");
var _keperJpgDefault = parcelHelpers.interopDefault(_keperJpg);
// De scene
...
function VariabelenInLezen() {
    ...
    if (OptieDekPlanken || BodemOptiePlanken == true) Breedte = Math.max(Breedte, MaxBreedte, MaxBreedte2);
...
function Bodem_GEN() {
    ...
    if (BodemOptiePlaat == true) {
        let Plaat = createBoxWithEdges(new _three.BoxGeometry(Breedte, PlaatDikte, Lengte), PlaatMateriaal);
    ...
    //************spreiding van aantal planken over dek************
        ...
        for(let i = 0; i < AantalBodemPlanken; i++){
            ...
            let Plank = createBoxWithEdges(new _three.BoxGeometry(DekPlankBreedte, DekPlankHoogte, Lengte), KeperColorMat);
            // Positioneren onder de kist
...
function UpdateModel() {
    ...
    OptiePlank();
    VerwijderOnderdelen();
    if (document.getElementById("BodemCheck").checked) Bodem_GEN();
    Keper_GEN();
    Dek_GEN();
}
//
...
},{"three":"dsoTF","three/examples/jsm/controls/OrbitControls.js":"45ipX","../img/OSB.jpg":"1jVM1","../img/KEPER.jpg":"8ntW0","@parcel/transformer-js/src/esmodule-helpers.js":"jnFvT"}],"1jVM1":[function() {},{}],"8ntW0":[function() {},{}]},["f5LC8","ids6w"], "ids6w", "parcelRequire94c2", {})

//# sourceMappingURL=pallet_2wegs.20914779.js.map
