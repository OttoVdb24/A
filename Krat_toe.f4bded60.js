...
})({"1Nsox":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "b002ab42f4bded60";
"use strict";
...
},{}],"jYoAG":[function(require,module,exports,__globalThis) {
...
let KeperAfstand;
let KeperAantal;
let PlaatDikte = 0.005;
let PlankDikte = 0.02;
let PlankBreedte = 0.075;
let KeperBreedte = 0.05;
let KeperHoogte = 0.1;
let DekPlankBreedte = 0.075;
let DekPlankHoogte = 0.018;
...
function DekPlanken_GEN() {
    ...
    for(let i = 0; i < AantalDekPlanken; i++){
        ...
        let DekPlank = createBoxWithEdges(new _three.BoxGeometry(DekPlankBreedte, DekPlankHoogte, Lengte + 2 * KopDikte), LatColorMat);
...
function DekPlaten_GEN() {
    let DekPlaat = createBoxWithEdges(new _three.BoxGeometry(Breedte, PlaatDikte, Lengte + 2 * KopDikte), OSBColorMat);
...
function Keper_GEN() {
    ...
    for(let i = 0; i < KeperAantal; i++){
        ...
        let Keper = createBoxWithEdges(new _three.BoxGeometry(Breedte + 2 * PlaatDikte, KeperHoogte, KeperBreedte), KeperColorMat);
    ...
    else KeperHefAfstand = 2 * Spacing - 2 * KeperBreedte;
...
function Koppen_GEN() {
    ...
    for (let richting of [
        ...
        let Kop = createBoxWithEdges(new _three.BoxGeometry(Breedte, Hoogte, PlaatDikte), OSBColorMat);
    ...
    for(let i = 0; i < 4; i++){
        // Maak een staander
        let Staander = createBoxWithEdges(new _three.BoxGeometry(PlankBreedte, Hoogte, PlankDikte), LatColorMat);
    ...
    for(let i = 0; i < 4; i++){
        // Maak een regel
        let Regel = createBoxWithEdges(new _three.BoxGeometry(Breedte - 2 * PlankBreedte, PlankBreedte, PlankDikte), LatColorMat);
        // Bepaal de x- en z-positie voor de vier hoeken
...
function ZijKanten_GEN() {
    ...
    for (let richting of [
        ...
        let ZijKant = createBoxWithEdges(new _three.BoxGeometry(PlaatDikte, ZijKantHoogte, ZijKantBreedte), OSBColorMat);
    ...
    for(let i = 0; i < KeperAantal; i++){
        ...
        for (let richting of [
            ...
            const ZijkantStaander = createBoxWithEdges(new _three.BoxGeometry(PlankDikte, hoogteStaander, PlankBreedte), LatColorMat);
    ...
    for (let richting of [
        ...
        let ZijKantRegel = createBoxWithEdges(new _three.BoxGeometry(PlankDikte, PlankBreedte, Lengte + 2 * KopDikte), LatColorMat);
...
function Deksel_GEN() {
    let Deksel = createBoxWithEdges(new _three.BoxGeometry(Breedte + 2 * PlaatDikte + 2 * PlankDikte, PlaatDikte, Lengte + 2 * KopDikte), OSBColorMat);
    ...
    for(let i = 0; i < KeperAantal; i++){
        let zPos = StartZ + i * Spacing;
        let Ligger = createBoxWithEdges(new _three.BoxGeometry(Breedte + 2 * PlankDikte + 2 * PlaatDikte, PlankDikte, PlankBreedte), LatColorMat);
        // Positioneren onder de kist
...
},{"three":"dsoTF","three/examples/jsm/controls/OrbitControls.js":"45ipX"}]},["1Nsox","jYoAG"], "jYoAG", "parcelRequire94c2", {})

//# sourceMappingURL=Krat_toe.f4bded60.js.map
