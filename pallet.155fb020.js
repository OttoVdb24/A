...
})({"1YFeC":[function(require,module,exports,__globalThis) {
...
module.bundle.HMR_BUNDLE_ID = "687e25a2155fb020";
"use strict";
...
},{}],"91rEI":[function(require,module,exports,__globalThis) {
...
function Blokken_GEN() {
    ...
    if (AantalBodemPlanken % 2 == 0) OpeningDwars = 1 * spacingX - 1 * BlokBreedte;
    else OpeningDwars = 2 * spacingX - 1 * BlokBreedte;
    //Opening uitrekenen en terugsturen naar html
    if (AantalTussenPlanken % 2 == 0) OpeningLangs = 1 * spacingZ - 1 * BlokBreedte;
    else OpeningLangs = 2 * spacingZ - 1 * BlokBreedte;
...
},{"three":"dsoTF","three/examples/jsm/controls/OrbitControls.js":"45ipX"}]},["1YFeC","91rEI"], "91rEI", "parcelRequire94c2", {})

//# sourceMappingURL=pallet.155fb020.js.map
